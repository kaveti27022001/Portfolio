...
redirect_from: 
  ...
  - /about.html
---
<img src="/images/Professional_img.jpg" alt="Chinmai Kaveti" style="float: right; width: 300px; margin-left: 20px; margin-bottom: 10px; border-radius: 8px;">
...
I have built and deployed solutions for:

Customer Segmentation & Retention using RFM and CLV modeling

Fraud Detection at large scale with highly imbalanced datasets

AI-powered Career Recommendation Systems using embeddings and agent-based architectures

RAG-based Chatbots leveraging LLMs, vector databases, and prompt optimization

Across projects and internships, I consistently focus on model performance, scalability, and reliability, achieving improvements in accuracy, latency, and throughput through rigorous EDA, feature engineering, hyperparameter tuning, and cloud-native deployment practices. I am experienced with CI/CD pipelines, containerization, and microservices-based ML systems.
